...
function Get-RecommendedRuntimeChannel {
    ...
    # PyTorch 2.12 / CUDA 13.0 is now the default runtime for all supported GPUs.
...
function Get-RuntimeChannelLabel {
    ...
    return "Default - PyTorch 2.12 / CUDA 13.0"
}
...
function Show-HardwareProfileDialog {
    ...
    $runtimeRecommendation = "PyTorch 2.12 / CUDA 13.0 (default for RTX 30/40/50 series)"
    ...
    $newRadio.Text = "Default - PyTorch 2.12 / CUDA 13.0 (RTX 30/40/50 series)"
